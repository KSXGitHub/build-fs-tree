...
complete -c build-fs-tree -n "__fish_seen_subcommand_from populate" -s h -l help -d 'Prints help information'
complete -c build-fs-tree -n "__fish_seen_subcommand_from populate" -s V -l version -d 'Prints version information'
